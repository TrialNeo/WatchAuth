<template>
  ...
  <BaseCard title="个人资料中心" title-icon="HOutline:UserIcon">
    ...
    <div>
      ...
      <el-form :model="userInfoForm" class="custom-form" label-position="top">
        <el-row :gutter="20">
          <el-col :span="12">
      ...
      <HoverAnimateWrapper class="w-full" name="lift">
        <div
        ...
        >
          <div class="flex items-center justify-between gap-4">
            ...
            <el-button plain type="primary" @click="updatePasswordRef?.showDialog()">
              立即修改
            </el-button>
          </div>
        </div>
      ...
      <HoverAnimateWrapper class="w-full" name="lift">
        ...
        >
          ...
          <div class="flex items-center justify-between gap-4">
            ...
            <el-button plain type="danger" @click="deleteUser">立即注销</el-button>
          </div>
        </div>
      </HoverAnimateWrapper>
    </div>
