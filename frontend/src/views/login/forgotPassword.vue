<template>
  <div class="form-content-inner">
    ...
    <el-form :model="forgotPasswordForm" class="forgot-password-form" label-position="top">
      <el-form-item>
        <el-input v-model="forgotPasswordForm.email" placeholder="请输入注册时的邮箱地址" />
      </el-form-item>
      <el-button class="submit-btn" type="primary" @click="handleAction"> 发送重置链接 </el-button>
      <div class="back-link">
