...
import type {IMachineListResp, ITopUpParams, IUserItemResp, ILogListResp} from '@/types/userManager/user.ts'
...
export const MachineManager = {
  list(params?: { deviceId: string; belong: string }) {
    return request.get<IMachineListResp>('admin/machine/list', { params })
  },
