    ...
    <el-scrollbar :height="height">
      <div class="team-list">
        <div v-for="item in teamData" :key="item.name">
          <HoverAnimateWrapper intensity="light" name="lift" style="width: 100%">
            <div class="team-item">
              <div class="avatar-wrap">
                <el-avatar :size="40" :src="item.avatar" />
                <span :class="item.status" class="status-dot" />
              </div>
              ...
              <div class="action">
                <el-button :icon="menuStore.iconComponents['Element:ChatDotRound']" circle />
              </div>
            </div>
          </HoverAnimateWrapper>
        </div>
