<template>
  <BaseDialog
    ...
    @close="close"
  >
    <div :class="{ 'is-mobile': menuStore.isMobile }" class="avatar-container">
        ...
        <transition mode="out-in" name="fade-slide">
          <div :key="activeMenu" style="height: 100%">
            ...
            <div v-else-if="activeMenu === 'cat'" class="cat-container">
              <el-input v-model="avatarSearchText" clearable placeholder="搜索头像名称">
                <template #prefix>
    ...
    <template #footer>
      ...
      <el-button :disabled="!selectedAvatar" type="primary" @click="updateAvatar">确定</el-button>
    </template>
  </BaseDialog>
</template>
